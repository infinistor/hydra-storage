...
export default class UsersView extends JetView {
	config() {
		return {
			...
			rows: [
				{
					type: "header", template: "<span style='font-weight: 100; margin-right: 5px'>Users / Groups</span> <span style='font-weight: 100; margin-right: 5px'>></span> <span>Users</span>",
					borderless: true,
				},
				UserTab
			],
	...
	resizeElement() {
		...
		if (usersView) {
			...
			usersView.config.height = height - (topBar + notificationWindowDatatable + notificationBar)
			usersView.resize()
		}
	}
}