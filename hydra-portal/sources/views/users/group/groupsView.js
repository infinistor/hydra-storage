...
export default class GroupsView extends JetView {
	config() {
		return {
			...
			rows: [
				{
					type: "header", template: "<span style='font-weight: 100; margin-right: 5px'>Users / Groups</span> <span style='font-weight: 100; margin-right: 5px'>></span> <span>Groups</span>",
					borderless: true,
				},
				GroupTab
			],
	...
	resizeElement() {
		...
		if (groupsView) {
			...
			groupsView.config.height = height - (topBar + notificationWindowDatatable + notificationBar)
			groupsView.resize()
		}
	}
}