...
export default class SystemView extends JetView {
	config() {
		return {
			...
			rows: [
				{
					type: "header", template: "<span style='font-weight: 100; margin-right: 5px'>Settings</span> <span style='font-weight: 100; margin-right: 5px'>></span> <span>System</span>",
					borderless: true,
				},
				SystemTab
			],
	...
	resizeElement() {
		...
		if (systemView) {
			...
			systemView.config.height = height - (topBar + notificationWindowDatatable + notificationBar)
			systemView.resize()
		}
